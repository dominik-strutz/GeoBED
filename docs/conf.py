...
# Inspired by: the Zuko documnentation by François Rozet: https://github.com/francois-rozet/zuko/blob/master/docs/conf.py
...
package = 'geobed'
project = 'GeoBED'
version = geobed.__version__
version = '0.0.0'
copyright = '2023, Dominik Strutz'
repository = 'https://github.com/dominik-strutz/GeoBED'
